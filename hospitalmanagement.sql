...
insert into Doctor(name,speciality,email) values('mani','cardiology','man@17'),
...
('babu','phisiology','babu@29'),('kavin','scyclogist','kavin@12'),
('hem','astrology','hem@78'),('visu','sociologist','vishal@88');
